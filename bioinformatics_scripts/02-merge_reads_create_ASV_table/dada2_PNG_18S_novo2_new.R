...
path <- "/storage/praha1/home/solakh/data/papuang/novogene2/dem_trim_tail_18S2"  ## CHANGE ME to the directory containing the fastq files.
list.files(path)
...
setwd("/storage/praha1/home/solakh/data/papuang/novogene2/dem_trim_tail_18S2")
...
save(derepFs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo2/derepFs_PNG_18S_novo2.R")
save(derepRs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo2/derepRs_PNG_18S_novo2.R")
...
save(dadaFs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo2/dadaFs_18S_novo2.R")
save(dadaRs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo2/dadaRs_18S_novo2.R")
...
#save results
save(seqtab,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo2/otutab_PNG_18S_novo2.R")
