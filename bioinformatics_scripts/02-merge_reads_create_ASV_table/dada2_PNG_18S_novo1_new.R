...
path <- "/storage/praha1/home/solakh/data/papuang/novogene2/dem_trim_tail_18S1"  ## CHANGE ME to the directory containing the fastq files.
list.files(path)
...
setwd("/storage/praha1/home/solakh/data/papuang/novogene2/dem_trim_tail_18S1")
...
save(derepFs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo1/derepFs_PNG_18S_novo1.R")
save(derepRs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo1/derepRs_PNG_18S_novo1.R")
...
save(dadaFs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo1/dadaFs_18S_novo1.R")
save(dadaRs,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo1/dadaRs_18S_novo1.R")
...
#save results
save(seqtab,file="/storage/praha1/home/solakh/data/papuang/novogene2/seqtab_18S_novo1/otutab_PNG_18S_novo1.R")
